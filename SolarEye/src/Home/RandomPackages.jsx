...
//       className="bg-gradient-to-r from-[#185B8D] to-[#4ACEF4] text-white px-8 py-3 rounded-xl text-lg font-semibold flex items-center justify-center space-x-2 hover:bg-[#3A9AD3] transition-all shadow-lg"
//     >
