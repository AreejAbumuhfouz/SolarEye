...
//   const [isProcessing, setIsProcessing] = useState(false);
//   const [isCompleted, setIsCompleted] = useState(false);
//   const [isPaymentConfirmed, setIsPaymentConfirmed] = useState(false); // إضافة هذه الحالة
...
//       await handleConfirmation();
//       setIsCompleted(true);
//       setIsPaymentConfirmed(true); // تأكيد الدفع
//     } catch (error) {
//       console.error('Payment error:', error);
//     } finally {
//       setIsProcessing(false);
...
//           whileTap={{ scale: 0.98 }}
//           onClick={handlePaymentConfirmation}
//           disabled={isProcessing || isCompleted || !isPaymentConfirmed} // زر غير مفعل حتى يتم التأكيد من الدفع
//           className={`
//             w-full px-6 py-4 rounded-lg shadow-md font-semibold
//             flex items-center justify-center space-x-2
//             transition-all duration-200
...
//               : 'bg-blue-600 hover:bg-blue-700'
//             }
//             ${isProcessing || isCompleted || !isPaymentConfirmed ? 'cursor-not-allowed opacity-90' : ''}
//             text-white
//           `}
//         >
//           {isProcessing ? (
