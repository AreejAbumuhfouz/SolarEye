...
// //         Thank you for signing up with SolarEye! To complete your registration, please use the following One-Time Password (OTP) to verify your email address:
...
// //     // Send email asynchronously using await
...
//     // Create new user (without isVerified field)
//     const newUser = new User({ email, password, name, city });
//     await newUser.save();
...
//     console.log('OTP is valid, comparing...');
//     // Compare the received OTP with the stored one in the session
//     if (parseInt(otp) === req.session.otp) {
//       // OTP is valid, update user as verified (or mark as verified in session)
...
//       // Assuming `user.isVerified` is your field, mark the user as verified
//       user.isApproved = true;  // Modify if you want to set a different field or action
//       await user.save();
...
//     }
//   } else {
//     // If OTP is expired or not found in the session
